...
\begin{frame}[fragile]{Interrompre proprement un thread}
  ...
  \begin{block}{Méthode \lstinline|public void interrupt()|}
    ...
    \item La tâche peut (doit) vérifier régulièrement les demandes d'interruption
      \begin{itemize}
      \item \lstinline|public static boolean interrupted()| \hspace{\fill} rebaisse le drapeau
      \item \lstinline|public boolean isInterrupted()|      \hspace{\fill} ne rebaisse pas le drapeau
      \end{itemize}
