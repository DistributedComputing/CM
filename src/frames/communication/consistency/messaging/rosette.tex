...
\begin{frame}{Carte des critères de cohérence faibles}
  ...
  \onBlock[y=-5mm]{Critères secondaires}{
    \begin{itemize}
  ...
  \onBlock[bottom=4mm]{Critères forts}{
    \begin{itemize}
  ...
  \footnoteref{M. Perrin. \textit{Spécification des objets partagés dans les systèmes répartis sans-attente.} (2016)}
