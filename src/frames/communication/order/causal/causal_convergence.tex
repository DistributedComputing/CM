...
\begin{frame}{Mémoire causalement convergente}
  ...
  \on<2->[y=18mm, x=35mm]{
    \begin{tikzpicture}[anchor=center]
      \node[inner sep=0pt, outer sep=0pt, text width=40mm, text height=25mm] (execution)  at (0,0) {};
      \node[inner sep=0pt, outer sep=0pt, text width=25mm, text height=25mm] (concurrent) at (0,0) {};
      \node[inner sep=0pt, outer sep=0pt, text width=40mm, text height=08mm] (local)      at (0,0) {};
      \node[inner sep=0pt, outer sep=0pt, text width=08mm, text height=08mm] (present)    at (0,0) {};
