...
\begin{frame}{Linéarisabilité}
  ...
  \begin{block}{Définition -- Linéarisabilité}
    ...
    \item[Opérations :] $H$ et $H_S$ contiennent les mêmes opérations $o_i$ ;
    ...
    \begin{tikzpicture}[x=10mm,y=7mm]
      \draw[densely dotted] (0,3) node[left]{$H_S$} -- (9,3);
  ...
  \footnoteref{M. Herlihy, J. Wing. \textit{Linearizability: A correctness condition for concurrent objects}. TOPLAS (1990)}  
