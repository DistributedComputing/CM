...
\begin{frame}{Motifs en messages et en mémoire}
  ...
  \onBlock[top=5mm]{Motifs en passage de messages (\STA-broadcast)}{}
  ...
  \on[y=5mm]{
    \begin{tikzpicture}[x=8mm, y=7mm]
      ...
      \draw[message, structure] (1,0) node[below left]{$m_2$} to[bend right=30] (3,0);
      \draw[message, structure] (1,0)                         --                (3,1);
  ...
  \on[y=5mm, x=38mm]{
    \begin{tikzpicture}[x=8mm, y=7mm]
      ...
      \draw[message, example]   (1,1) node[above left]{$m_1$} to[bend left=30]  (3,1);
      \draw[message, example]   (1,1)                         --                (2,0);
      \draw[message, structure] (1,0) node[below left]{$m_2$} to[bend right=30] (3,0);
  ...
  \onBlock<2>[y=-13mm]{Motifs en mémoire partagée (registres atomiques \Read/\Write)}{}
