...
\begin{frame}{Motifs en messages et en mémoire}
  ...
  \on<2>[y=-29mm, x=-38mm]{
    \begin{tikzpicture}[x=7mm, y=7mm]
      ...
      \tiny
      \node[example,   operation, inner sep=1pt] at (1  ,1) {$x_1.\Write(1)$};
      \node[structure, operation, inner sep=1pt] at (1  ,0) {$x_2.\Write(1)$};
      \node[structure, operation, inner sep=1pt] at (2.8,1) {$x_2.\Read() \rightarrow 0$};
      \node[example,   operation, inner sep=1pt] at (2.8,0) {$x_1.\Read() \rightarrow 0$};
  ...
  \on<2>[y=-29mm]{
    \begin{tikzpicture}[x=7mm, y=7mm]
      ...
      \node[structure, operation, inner sep=1pt] at (1  ,0) {$x_2.\Write(1)$};
      \node[structure, operation, inner sep=1pt] at (2.8,1) {$x_2.\Read() \rightarrow 0$};
      \node[example,   operation, inner sep=1pt] at (2.8,0) {$x_1.\Read() \rightarrow 1$};
    \end{tikzpicture}
  }
  ...
  \on<2>[y=-29mm, x=38mm]{
    \begin{tikzpicture}[x=7mm, y=7mm]
      ...
      \node[example,   operation, inner sep=1pt] at (1  ,1) {$x_1.\Write(1)$};
      \node[structure, operation, inner sep=1pt] at (1  ,0) {$x_2.\Write(1)$};
      \node[structure, operation, inner sep=1pt] at (2.8,1) {$x_2.\Read() \rightarrow 1$};
      \node[example,   operation, inner sep=1pt] at (2.8,0) {$x_1.\Read() \rightarrow 1$};
    \end{tikzpicture}
  }
