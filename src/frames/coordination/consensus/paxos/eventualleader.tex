...
\begin{frame}[fragile]{Élection de leader}
  ...
  \on<4>[bottom=-2mm,text]{
    \begin{citing}
    \item[CHT96] T. Chandra, V. Hadzilacos, S. Toueg. \textit{The weakest failure detector for solving consensus.} JACM. 1996.
    \item[CT96] T. Chandra, S. Toueg. \textit{Unreliable failure detectors for reliable distributed systems.} JACM. 1996.
    \end{citing}
  }
