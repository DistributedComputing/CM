...
\begin{frame}{L'abstraction Abort-Adopt-Commit}
  ...
  \only<2>{
    \footnoteref{E. Gafni. \textit{Round-by-round fault detectors unifying synchrony and asynchrony.} PODC (1998)}
    \footnoteref{H. Attiya, J. Welch. \textit{Multi-Valued Connected Consensus: A New Perspective on Crusader Agreement and Adopt-Commit.} OPODIS (2023)}
  }
