...
\begin{frame}{Un common coin simple $(t < \sqrt{n})$}
  ...
  \ob<-2>[bottom=-2mm, text]{
    \begin{citing}
    \item[R83] M. Rabin. \emph{Randomized byzantine generals.} SFCS. 1983
    \item[AH90] J. Aspnes, M. Herlihy. \emph{Fast randomized consensus using shared memory.} J. of Algorithms. 1990
    \end{citing}
  }
