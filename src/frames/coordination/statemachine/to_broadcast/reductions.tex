...
\tikzset{
  box/.style={draw, rounded corners, text width=20mm, minimum height=9mm, align=center, draw highlighted, fill highlighted, text highlighted},
}

\begin{frame}{Réductions à explorer}
  
  \begin{tikzpicture}[x=28mm, y=15mm, font=\scriptsize]
  ...
  \begin{block}{Comment implémenter Total-order Broadcast ?}
    \begin{itemize}
    \item \structure{\TO-broadcast} est équivalent au \structure{consensus} en calculabilité
    \item Les deux ont besoin d'hypothèses sur le système $\mathcal{CAMP}_{n,t}$
      ...
      \item Des périodes assez stables pour choisir un \alert{leader}
      \end{itemize}
    \item On implémente le consensus pour implémenter \TO-broadcast
    \end{itemize}
  \end{block}
