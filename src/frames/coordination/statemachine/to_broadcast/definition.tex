...
\begin{frame}{Total-Order Broadcast (Atomic Broadcast)}
  ...
  \onBlock[bottom=9mm]{Remarques}{
    \vspace{-1mm}
    \begin{itemize}
    \item Total-Ordering $\Rightarrow$ Mutual-Ordering $\Rightarrow$ Causal-Ordering $\Rightarrow$ FIFO-Ordering
  ...
  \on[bottom=-2mm, text]{
    \begin{citing}
    \item[BJ87] K. P. Birman, T. A. Joseph. \emph{Reliable Communication in the Presence of Failures}. TOCS, 1987.
