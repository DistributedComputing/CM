...
Third-party materials, images, code excerpts, attribution requirements, and exceptions are documented in the [organization-wide licensing notice](https://github.com/DistributedComputing/.github/blob/main/LICENSE.md).
